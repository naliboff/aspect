...
#ifndef _aspect_particle_property_heat_flux_h
#define _aspect_particle_property_heat_flux_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Property
    {
       ...
       */
      template <int dim>
      class HeatFlux : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
      {
        public:
          /**
           * Constructor.
